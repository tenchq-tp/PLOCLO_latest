...
CREATE TABLE IF NOT EXISTS students (
    ...
    UNIQUE KEY unq_student_program_year (student_id, program_id, year),
    INDEX idx_program_year (program_id, year),
    INDEX idx_student_id (student_id),
    CONSTRAINT fk_student_program FOREIGN KEY (program_id) REFERENCES programs(program_id) ON DELETE CASCADE,
    CONSTRAINT fk_student_university FOREIGN KEY (university_id) REFERENCES universities(university_id) ON DELETE CASCADE,
    CONSTRAINT fk_student_faculty FOREIGN KEY (faculty_id) REFERENCES facultys(faculty_id) ON DELETE CASCADE
);
